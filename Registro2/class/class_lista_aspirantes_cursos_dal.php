...
order by a.rfc";
        ...
        while($renglon = mysqli_fetch_assoc($rs)) {
                   $obj_det = new lista_aspirantes_cursos($renglon["RFC"],utf8_encode($renglon["NOMBRE"]),$renglon["PATERNO"],$renglon["MATERNO"],$renglon["EMPRESA"],$renglon["TELEFONO"],$renglon["EMAIL"],$renglon["ID_CURSO"],utf8_encode($renglon["NOMBRE_CURSO"]));
...
where ac.id_curso='$id_curso' and a.rfc='$rfc'";
        ...
        $i=0;
        while($renglon = mysqli_fetch_assoc($rs)) {
                   $obj_det = new lista_aspirantes_cursos($renglon["RFC"],utf8_encode($renglon["NOMBRE"]),$renglon["PATERNO"],$renglon["MATERNO"],$renglon["EMPRESA"],$renglon["TELEFONO"],$renglon["EMAIL"],$renglon["ID_CURSO"],$renglon["NOMBRE_CURSO"]);
